...
let person = ('ali');
console.log(person);
let message = ('hello ali,would you like to learn some python today?');
console.log(message);
//Exercise 3:
let personname = ('sam');
...
//Exercise 6:
let personNameWithWhiteSpace = "\t Ali Bariz \n";
...
//Exercise 11:
let names = ['Ali', 'Tom', 'Sam', 'Ahmad'];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
//Exercise 12:
let greetings = ['Ali', 'Tom', 'Sam', 'Ahmad'];
...
let beginningguest = "Bill";
guestlist.unshift(beginningguest);
console.log(guestlist);
let middleguest = "Zia khan";
...
let traveldestination = ["London", "Madina", "Dubai", "Paris", "New York City"];
...
const countries = ["Japan", "USA", "Scotland", "Italy", "Turkey"];
...
cars.push(car3);
// console.log(cars)
cars.push({ name: "Audi", price: 60000000, description: "it is a luxury and an expensive car" });
...
console.log(`fruit in index ${invalidindex}:`, fruits[invalidindex]);
...
const favoriteFruits = ["Apple", "Strawberry", "Watermelon"];
//using if statement.
...
//exercise 31:
//non empty array
const username = ['admin', 'Bill', 'Tom', 'Sam', 'Alex'];
function greetusers() {
...
greetusers();
//functional case
let usernames = ['admin', 'Bill', 'Tom', 'Sam', 'Alex'];
...
//excersise 32.
const current_users = ["Ali", "Ahmad", "Sam", "Alex", "Mark", "Jason"];
const new_users = ["Ali", "Akram", "Sam", "Amir", "Babar"];
...
console.log(album3);
//Exercise 41:
const magicianNames = ["Harry Potter", "Professor Albus Dumbledor", "Hermione Granger", "David Copperfield", "Ron Weasley"];
...
//Exercise 42:
const magicianNames1 = ["Harry Potter", "David Copperfield", "Ron Weasley", "Hermione Granger", "Professor Albus Dumbledor"];
function make_great(magicians) {
    const Greatmagicians = magicians.map(magician => `The Great ${magician}`);
    return Greatmagicians;
}
//modify the array to add "The Great"to each magician's name
const GreatMagiciansName = make_great(magicianNames1);
...
//Exercise 45:
function createcar(Manufacturer, carname, ...properties) {
    const car = {
        Manufacturer,
        carname,
    };
...
//Example
const MyCar = createcar("Honda", "City", ["color", "Black"], ["Optional feature",
    "Sunroof"]);
console.log(MyCar);
